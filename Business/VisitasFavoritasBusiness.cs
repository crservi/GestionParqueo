...
{
    public class VisitasFavoritasBusiness : IBusinessBase<Visitas>
    {
        private ServicioDB _servicioDB;
        public VisitasFavoritasBusiness(IConfiguration configuration)
        {
        ...
        public bool Crear(Visitas modelo, int usuarioId)
        {
            ...
            var data = _servicioDB.RetornaDatosDeProcedimiento("spCrearVisitaF", parametros);
        ...
        public bool Editar(Visitas modelo, int usuarioId)
        {
            ...
            var data = _servicioDB.RetornaDatosDeProcedimiento("spEditarVisitaF", parametros);
            string resultado = string.Empty;
        ...
        public bool Eliminar(int id, int usuarioId)
        {
            ...
            var data = _servicioDB.RetornaDatosDeProcedimiento("spEliminaVisitaF", parametros);
            string resultado = string.Empty;
        ...
        public List<Visitas> Obtener(Visitas modelo, int usuarioId)
        {
            ...
            var parametros = new List<Parametros>();
            parametros.Add(new Parametros { Nombre = "seleccionVisitaFId", Valor = modelo.Id });
            parametros.Add(new Parametros { Nombre = "usuarioId", Valor = usuarioId });

            var data = _servicioDB.RetornaDatosDeProcedimiento("spSeleccionaVisitasF", parametros);
